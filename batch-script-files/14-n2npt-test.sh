...
#SBATCH -J 14-n2npt-test           				              # Job name
...
pipenv run python src/test.py -d new_test_data/256/ -n ${noise} -p ${param} -c ${crop} --output results --load-ckpt "${ckpt_name}" --show-output 4 --cuda
