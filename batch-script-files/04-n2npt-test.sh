...
#SBATCH -J 04-n2npt-test           				        # Job name
...
pdm run python src/test.py -d new_test_data/256/ -n ${noise} -p ${param} --show-output ${show} -c ${crop} --output ${results} --load-ckpt "${ckpt_name}" --cuda
