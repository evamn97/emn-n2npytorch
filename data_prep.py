...
if __name__ == '__main__':
    ...
    # root = "speed_hs20mg_data/targets"
    # mode = 'first'
    # new_string = 'target_'
    #
    # batch_rename(root, mode, new_string)

    # ---------------------------------------------------------------- Data Augmenting ----------------------------------------------------------------
    # Augmenting data
    source_in_dir = "C:/Users/eva_n/OneDrive - The University of Texas at Austin/SANDIA PHD RESEARCH/Ryan-AFM-Data/Combined-HS20MG-256/xyz-conversions"
    source_out_dir = "hs20mg_xyz_data"
    target_in_dir = "C:/Users/eva_n/OneDrive - The University of Texas at Austin/SANDIA PHD RESEARCH/Ryan-AFM-Data/Combined-HS20MG-256/xyz-extra-processed"
